...
void pigeon_init() {
  ...
  // init from ubloxd
  //UBX-CFG-PRT: [03 FF 00 00 00 00 00 00 00 00 00 00 01 00 01 00 00 00 00 00]
  //             [portId=USB, inProtoMask=inUbx, outProtoMask=outUbx]
  ...
  //UBX-CFG-PRT: [00 FF 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00]
  ...
  //UBX-CFG-PRT: [01 00 00 00 C0 08 00 00 00 08 07 00 01 00 01 00 00 00 00 00]
  //             [portId=UART 1, mode=..., baudRate=460800, inProtoMask=inUbx+inNmea+inRtcm+inRtcm3, outProtoMask=outUbx]
  __pigeon_gps_send_string("\xB5\x62\x06\x00\x14\x00\x01\x00\x00\x00\xC0\x08\x00\x00\x00\x08\x07\x00\x27\x00\x01\x00\x00\x00\x00\x00\x1A\xB0");
